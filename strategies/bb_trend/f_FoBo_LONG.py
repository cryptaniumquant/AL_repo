...
def main():
    ...
    strategy_results = f_FoBo_LONG(bars_df, _symbol, _init_deposit, _max_pct_risk, _pct_of_reinvest, *params_to_optimize)
    ...
    print(strategy_positions_df.tail(10))
